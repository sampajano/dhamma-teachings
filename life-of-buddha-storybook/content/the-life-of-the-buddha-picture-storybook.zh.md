...
随后，佛陀宣说四圣谛。被执取束缚的生命有苦：出生、衰老、疾病、死亡、相爱者分离、所求不得，以及执著身心为“我”的沉重。苦的集起来自渴爱；渴爱一次次寻找欢喜，推动生命继续追逐与轮转。苦的止息，是渴爱的离贪、止息与放下。通向止息的，则是一条需要亲身修习的道路。

这条道路就是八支圣道：正见、正思惟、正语、正业、正命、正精进、正念、正定。它不是只供人相信的一套说法，而是同时训练理解、行为与定力，使智慧能够如实照见，使心真正走向解脱。
